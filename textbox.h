...
struct Text {
    ...
    Text(sf::Vector2u windowSize) {  // Add window size parameter to constructor
        ...
        setupText(y1, "2020", 38, sf::Color::White, sf::Vector2f(windowSize.x * 0.30f, windowSize.y * 0.85f));
        setupText(y2, "2021", 38, sf::Color::White, sf::Vector2f(windowSize.x * 0.40f, windowSize.y * 0.85f));
        setupText(y3, "2022", 38, sf::Color::White, sf::Vector2f(windowSize.x * 0.50f, windowSize.y * 0.85f));
        setupText(y4, "2023", 38, sf::Color::White, sf::Vector2f(windowSize.x * 0.60f, windowSize.y * 0.85f));
